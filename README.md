...
Each attack upgrade add 20% damage increase to item used, calculated after vanilla bonus from prefix.  
Defense upgrade add flat +1 defense to armor and accessories.  
All stats changes are resettable using "Resetter" item, crafted using 2 mana crystals on workbenches.  
...
(also limitations won't be back until I find a saner way to do it. Sorry.)  

Source code at [Github.](https://github.com/atusmk2/yasumi/)  

Changelog  
=========
v0.2.0 - Changed +2 flat summon damage to +20% damage bonus per upgrade. Moving all tooltips to Localization files.  
